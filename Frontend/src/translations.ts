...
const en: TranslationKeys = {
    ...
    feat2Desc: 'Paste forwarded WhatsApp and Telegram messages for instant misinformation detection using NLP analysis.',
    feat3Title: 'Multilingual Indian Language Support',
    feat3Desc: 'Analyze content in Hindi, Tamil, Telugu, Bengali and 12 more Indian languages powered by Gemini AI.',
    feat4Title: 'Real-time Social Media Monitoring',
    feat4Desc: 'Submit social media URLs for instant credibility analysis across Twitter/X, Facebook and YouTube.',
    feat5Title: 'Health Misinformation Shield',
    feat5Desc: 'Specialized detection for false medical claims, unproven treatments and vaccine misinformation.',
    feat6Title: 'Media Literacy Education Engine',
    feat6Desc: 'Every scan includes a detailed educational breakdown teaching users how to spot manipulation techniques.',
    ...
    edu2Check3: 'Use TruthLens\'s source database to instantly check a domain\'s credibility history',
    ...
    edu3Check3: 'TruthLens automatically performs reverse search and metadata analysis on every image upload',
    ...
    ctaTitle: 'DEFEND\nTRUTH\nTOGETHER',
    ctaSub: 'Free for individuals. Join 180,000 Indians who already use TruthLens to fight misinformation every day.',
    ctaBtn: 'Get Started Free',

    // Footer
    footerCopy: '© 2025 TruthLens. Built in India. Fighting for truth.',
...
const hi: TranslationKeys = {
    ...
    edu2Check3: 'किसी डोमेन की विश्वसनीयता इतिहास तुरंत चेक करने के लिए TruthLens के स्रोत डेटाबेस का उपयोग करें',
    ...
    edu3Check3: 'TruthLens हर इमेज अपलोड पर स्वचालित रूप से रिवर्स सर्च और मेटाडेटा विश्लेषण करता है',
    ...
    ctaTitle: 'सत्य की\nरक्षा\nमिलकर करें',
    ctaSub: 'व्यक्तियों के लिए मुफ़्त। 1,80,000 भारतीयों से जुड़ें जो पहले से हर दिन गलत सूचना से लड़ने के लिए TruthLens का उपयोग करते हैं।',
    ctaBtn: 'मुफ़्त शुरू करें',

    // Footer
    footerCopy: '© 2025 TruthLens. भारत में बना। सत्य के लिए लड़ रहा है।',
...
const ta: TranslationKeys = {
    ...
    edu2Check3: 'டொமைனின் நம்பகத்தன்மை வரலாற்றை உடனடியாக சரிபார்க்க TruthLens-ன் ஆதார தரவுத்தளத்தைப் பயன்படுத்தவும்',
    ...
    edu3Check3: 'TruthLens ஒவ்வொரு பட பதிவேற்றத்திலும் தானாகவே ரிவர்ஸ் தேடல் மற்றும் மெட்டாடேட்டா பகுப்பாய்வு செய்கிறது',
    ...
    ctaTitle: 'உண்மையை\nபாதுகாப்போம்\nஒன்றாக',
    ctaSub: 'தனிநபர்களுக்கு இலவசம். ஒவ்வொரு நாளும் தவறான தகவல்களை எதிர்த்துப் போராட ஏற்கனவே TruthLens-ஐப் பயன்படுத்தும் 1,80,000 இந்தியர்களுடன் இணையுங்கள்.',
    ctaBtn: 'இலவசமாக தொடங்கு',

    // Footer
    footerCopy: '© 2025 TruthLens. இந்தியாவில் உருவாக்கப்பட்டது. உண்மைக்காக போராடுகிறது.',
...
const te: TranslationKeys = {
    ...
    edu2Check3: 'డొమైన్ యొక్క విశ్వసనీయత చరిత్రను తక్షణమే తనిఖీ చేయడానికి TruthLens యొక్క సోర్స్ డేటాబేస్‌ను ఉపయోగించండి',
    ...
    edu3Check3: 'TruthLens ప్రతి ఇమేజ్ అప్‌లోడ్‌లో ఆటోమాటిక్‌గా రివర్స్ సెర్చ్ మరియు మెటాడేటా విశ్లేషణ చేస్తుంది',
    edu4Tab: 'గణాంక మోసం',
    edu4Title1: 'గణాంక ',
    edu4Title2: 'మోసం',
    ...
    ctaTitle: 'సత్యాన్ని\nరక్షిద్దాం\nకలిసి',
    ctaSub: 'వ్యక్తులకు ఉచితం. ప్రతిరోజూ తప్పుడు సమాచారంతో పోరాడటానికి ఇప్పటికే TruthLens ఉపయోగిస్తున్న 1,80,000 భారతీయులతో చేరండి.',
    ctaBtn: 'ఉచితంగా ప్రారంభించు',

    // Footer
    footerCopy: '© 2025 TruthLens. భారతదేశంలో నిర్మించబడింది. సత్యం కోసం పోరాడుతోంది.',
...
const bn: TranslationKeys = {
    ...
    edu2Check3: 'একটি ডোমেইনের বিশ্বাসযোগ্যতার ইতিহাস তাৎক্ষণিকভাবে পরীক্ষা করতে TruthLens-এর সোর্স ডাটাবেস ব্যবহার করুন',
    ...
    edu3Check3: 'TruthLens প্রতিটি ছবি আপলোডে স্বয়ংক্রিয়ভাবে রিভার্স সার্চ এবং মেটাডেটা বিশ্লেষণ করে',
    ...
    ctaTitle: 'সত্য\nরক্ষা করুন\nএকসাথে',
    ctaSub: 'ব্যক্তিদের জন্য বিনামূল্যে। প্রতিদিন ভুল তথ্যের বিরুদ্ধে লড়াই করতে ইতিমধ্যে TruthLens ব্যবহার করা ১,৮০,০০০ ভারতীয়দের সাথে যোগ দিন।',
    ctaBtn: 'বিনামূল্যে শুরু করুন',

    // Footer
    footerCopy: '© ২০২৫ TruthLens. ভারতে তৈরি। সত্যের জন্য লড়াই।',
...
const mr: TranslationKeys = {
    ...
    edu2Check3: 'डोमेनचा विश्वासार्हता इतिहास तात्काळ तपासण्यासाठी TruthLens चा स्रोत डेटाबेस वापरा',
    ...
    edu3Check3: 'TruthLens प्रत्येक इमेज अपलोडवर स्वयंचलितपणे रिव्हर्स सर्च आणि मेटाडेटा विश्लेषण करते',
    ...
    ctaTitle: 'सत्याचे\nरक्षण\nएकत्र करा',
    ctaSub: 'व्यक्तींसाठी मोफत. दररोज चुकीच्या माहितीशी लढण्यासाठी आधीच TruthLens वापरणाऱ्या १,८०,००० भारतीयांसोबत सामील व्हा.',
    ctaBtn: 'मोफत सुरू करा',

    // Footer
    footerCopy: '© २०२५ TruthLens. भारतात बनवलेले. सत्यासाठी लढत आहे.',
    footerPrivacy: 'गोपनीयता',
    footerAPI: 'API',
